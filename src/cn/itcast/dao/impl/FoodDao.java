...
public class FoodDao implements IFoodDao{
	...
	public void save(Food food) {
		...
		try {
			JdbcUtils.getQuerrRunner().update(sql, food.getFoodName(),food.getFoodType_id(),food.getPrice(),food.getMprice(),food.getRemark(),food.getImg());
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
	}
	...
	public List<Food> getAll(String foodName){
		...
		try {
			return JdbcUtils.getQuerrRunner()
				.query(sql, new BeanListHandler<Food>(Food.class),"%" + foodName + "%");
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
}
